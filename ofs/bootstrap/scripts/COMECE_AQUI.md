...
```bash
bash ofs/bootstrap/scripts/setup-permissions.sh
```
...
└─────────────┬────────────────────────┘
              ↓
┌─ PHASE 3: Release ────────────────────┐
│ • Copia ofs/dist/ofscc                    │
│ • Copia ofs/dist/stdlib/                  │
│ • Cria version.json                   │
...
```bash
ofs/dist/ofscc check seu_programa.ofs
```

### Inspecionar Código
```bash
ofs/dist/ofscc tokens seu_programa.ofs   # Lexer
ofs/dist/ofscc ast seu_programa.ofs      # Parser
ofs/dist/ofscc ir seu_programa.ofs       # LLVM IR
ofs/dist/ofscc asm seu_programa.ofs      # Assembly
```
...
### Linux/macOS Bash
```bash
# Scripts localizados em ofs/bootstrap/scripts/
...
bash ofs/bootstrap/scripts/validate.sh -v
...
# Rodar testes
bash ofs/bootstrap/scripts/utils.sh test
```
