...
bash ofs/bootstrap/scripts/bootstrap-linux.sh --jobs $(nproc)
print_success "OFS compiler bootstrapped"

print_step "Phase 3: Validate build"
bash ofs/bootstrap/scripts/validate.sh
print_success "Validation complete"

print_step "Phase 4: Create release src/packages"
bash ofs/bootstrap/scripts/create-release.sh "$VERSION-$COMMIT"
print_success "Release src/packages created"
