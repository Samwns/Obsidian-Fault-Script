...
- `src/scripts/roadmap_completion.ps1`
...
│ Duration: 2 weeks                                                   │
│ Deliverables:                                                       │
│ - [x] Bootstrap test (Linux verified)                              │
...
│ - [ ] Linux src/packages (.deb, .rpm, AUR)                            │
...
jobs:
  build:
    ...
    steps:
      ...
      - name: Bootstrap Test
        run: bash ofs/ofs/bootstrap/test_bootstrap.sh
```
...
**Files Modified**:
- ofs/bootstrap/codegen.ofs → split into:
