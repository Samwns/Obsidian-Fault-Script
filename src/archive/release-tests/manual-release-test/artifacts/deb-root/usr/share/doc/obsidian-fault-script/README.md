...
- Standard modules and installable src/packages
...
| VS Code | Install `ofs-src/vscode-extension.vsix` |
| From Source | `bash ofs/bootstrap/scripts/bootstrap-minimal.sh` |
...
| VS Code | Instale `ofs-src/vscode-extension.vsix` |
| Do Fonte | `bash ofs/bootstrap/scripts/bootstrap-minimal.sh` |
...
- [Pacotes](src/packages/README.md)
- [Changelog](docs/CHANGELOG.md)