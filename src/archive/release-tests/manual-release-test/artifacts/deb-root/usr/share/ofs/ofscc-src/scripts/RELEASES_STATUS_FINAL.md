...
vim ofs/ofs/bootstrap/ofscc.ofs

# Test
bash ofs/bootstrap/scripts/bootstrap-minimal.sh

# Release
bash ofs/bootstrap/scripts/release-native-only.sh 1.0.1 --recompile
...
release:
  ...
  steps:
    ...
    - run: bash ofs/bootstrap/scripts/release-native-only.sh ${{ github.ref_name }} --recompile
